            ...
            <form action="{{ route('admin.students.update', $student->id) }}" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div class="flex flex-wrap mb-3">
                    <div class="w-full px-3">
                        ...
                        <input class="block w-full px-4 py-3 mb-3 input input-bordered bg-base-300" name="student_id" value="{{ $student->student_id }}" type="text" placeholder="">
                ...
                <div class="flex flex-wrap mb-6">
                    <div class="w-full px-3 md:w-1/2">
                        ...
                        <input class="w-full input input-bordered bg-base-300" name="first_name" value="{{ $student->first_name }}" type="text" placeholder="">
                        @error('first_name')<small class="text-danger">{{$message}}</small> @enderror
                    </div>

                    <div class="w-full px-3 md:w-1/2">
                        <label class="label-text" for="grid-name">Last Name</label>
                        <input class="w-full input input-bordered bg-base-300" name="last_name" value="{{ $student->last_name }}" type="text" placeholder="">
                ...
                <div class="flex flex-wrap mb-6">
                    <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                        ...
                        <input class="w-full input input-bordered bg-base-300" name="email" type="email" value="{{ $student->email }}" placeholder="">
