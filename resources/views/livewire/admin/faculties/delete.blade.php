...
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Delete Faculty</h3>
        <form wire:submit.prevent="destroyFaculty" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    <h5>Are you sure you want to permanently delete this faculty? This action cannot be undone.</h5>
                </div>
            </div>
