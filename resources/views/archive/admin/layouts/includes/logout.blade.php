...
<div dialog wire:ignore class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Logout</h3>
        <form id="logout-form" action="{{ route('archive.admin.logout') }}" method="POST" class="w-full mt-6">
            @csrf
