<x-guest-layout>
    ...
    <div class="hidden lg:flex flex-col gap-4 bg-base-100 p-6 justify-center lg:w-1/2">
        ...
        <h1 class="text-3xl font-bold self-center">Pi:Lock | Admin Register</h1>
    ...
    {{-- Right Pages --}}
    <div class="flex flex-col gap-4 bg-base-100 justify-center p-6 lg:w-1/2">
        {{-- Responsive Start --}}
        <img src="{{ asset('assets/images/pilock-white.png') }}" class="self-center lg:hidden" style="max-width: 30%; max-height: 30%" alt="" srcset="">
        <h1 class="text-3xl font-bold self-center lg:hidden">Pi:Lock | Admin Register</h1>
        {{-- Responsive End --}}
