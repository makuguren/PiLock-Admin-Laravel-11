...
<div>
    @include('livewire.archive.faculty.seatplan-view')
        ...
        <div class="p-6 mb-6 border-gray-100 rounded-md shadow-md bg-base-100 shadow-black/5">
            <div class="overflow-x-auto">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <a wire:navigate.hover href="{{ route('archive.faculty.seatplan.index') }}" class="bg-blue-700 btn btn-ghost hover:bg-blue-500 w-55 btn-sm">
