<div wire:poll.1s class="flex items-center justify-center">
    <div class="grid grid-cols-2 gap-2 p-10 text-white">
        @php
            ...
            $seatplan = \App\Models\Archive\SeatConfiguration::all()->groupBy('row');
        ...
        <div class="flex justify-center col-span-2 mt-5">
            <div class="flex items-center justify-center h-12 bg-blue-700 border border-black w-72">FACULTY TABLE</div>
        </div>
    </div>
</div>
