        ...
        <form wire:submit.prevent="saveEvent" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="title" id="addevent_title" class="input input-bordered bg-base-300 block w-full py-3 px-4 mt-1 mb-1 form-control" type="text">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="description" id="addevent_description" class="input input-bordered bg-base-300 block w-full py-3 px-4 mt-1 mb-1 form-control" type="text">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="date" value="" id="addevent_date" class="input input-bordered bg-base-300 block w-full py-3 px-4 mt-1 mb-1 form-control" type="text" disabled>
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="event_start" id="addevent_start" class="input input-bordered bg-base-300 block w-full py-3 px-4 mt-1 mb-1 flex-row form-control" type="time">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input wire:model="event_end" id="addevent_end" class="input input-bordered bg-base-300 block w-full py-3 px-4 mt-1 mb-1 flex-row form-control" type="time">
