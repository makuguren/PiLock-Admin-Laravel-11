        ...
        <form wire:submit.prevent="updateSchedule" method="dialog" class="w-full mt-6">
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    ...
                    <select wire:model="course_id" id="editcourse_id" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" disabled>
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    ...
                    <select wire:model="days" id="editdays" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" disabled>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3 md:w-1/3">
                    ...
                    <select wire:model="time_start" id="edittime_start" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" disabled>
                ...
                <div class="w-full px-3 md:w-1/3">
                    ...
                    <select wire:model="time_end" id="edittime_end" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" disabled>
                ...
                <div class="w-full px-3 md:w-1/3">
                    ...
                    <input wire:model="lateDuration" id="editlate_duration" class="block w-full px-4 py-3 mt-2 mb-2 input input-bordered bg-base-300 form-control" type="number" placeholder="0 - 60 minutes" disabled>
