...
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Delete Schedule</h3>
        <form wire:submit.prevent="destroySchedule" method="dialog" class="w-full mt-6">
            ...
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_sched()" type="button" class="btn bg-red-700 hover:bg-red-500 text-white">Cancel</button>
                </div>
            </div>
        </form>
    </div>
