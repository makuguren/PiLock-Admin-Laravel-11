    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="flex flex-col items-center text-center md:flex-row md:text-left">
            <div class="md:w-1/2">
                ...
                <p class="mt-4 text-2xl font-semibold text-gray-800">Uh-oh! We can't find that page.</p>
                <p class="mt-2 text-gray-600">It looks like the page you're looking for isn't here.</p>
                <a href="{{ url('/') }}" class="mt-6 text-white bg-blue-700 btn hover:bg-blue-500">Take me home</a>
            </div>
