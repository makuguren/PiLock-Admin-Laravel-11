<div class="z-40 drawer-side" style="scroll-behavior: smooth; scroll-padding-top: 5rem;">
    ...
    <aside class="w-64 h-full bg-base-100">
        ...
        <div data-sveltekit-preload-data class="sticky top-0 z-20 items-center hidden gap-2 px-4 py-2 bg-base-100 bg-opacity-90 backdrop-blur lg:flex ">
            <!-- Drawer Logo -->
            <a wire:navigate.hover href="{{ route('faculty.dashboard.index') }}" aria-current="page" aria-label="Homepage" class="px-2 flex-0 btn btn-ghost"
        ...
        <ul class="px-4 py-0 menu">
            <li class="mb-1 group {{ Request::is('faculty/dashboard') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('faculty.dashboard.index') }}"
            ...
            <li>
                <details id="disclosure-attendances">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('faculty/attendances') || Request::is('admin/attendances/*') || Request::is('faculty/attendances/current') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.attendances.current') }}"
                        ...
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.attendances.index') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                All Attendances
                            </a>
                        </li>
            ...
            <li class="mb-1 group {{ Request::is('faculty/events') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('faculty.events.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li>
                <details id="disclosure-courses">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('faculty/courses') || Request::is('faculty/courses/blockedstudents') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.courses.index') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Your Courses
                            </a>
                        </li>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.courses.blocked') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Blocked Students
                            </a>
                        </li>
            ...
            <li class="mb-1 group {{ Request::is('faculty/students') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('faculty.students.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li>
                <details id="disclosure-schedules">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('faculty/schedules') || Request::is('faculty/schedules/makeupscheds') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.schedules.index') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Your Schedules
                            </a>
                        </li>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('faculty.schedules.makeup') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
            ...
            <li class="mb-1 group {{ Request::is('faculty/seatplan') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('faculty.seatplan.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li class="mb-1 group {{ Request::is('faculty/settings') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('faculty.settings.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
