                ...
                <div class="flex flex-col gap-5 md:flex-row">
                    ...
                    <div class="w-full">
                        ...
                        <form wire:submit="filter_coursesec">
                            <select wire:model="filter_coursesec" class="flex items-center w-full mt-2 select select-bordered">
                    ...
                    <div class="w-full">
                        ...
                        <form wire:submit="filter_date">
                            <label class="flex items-center w-full">
                                <input type="date" wire:model="filter_date" name="date" value="" class="w-full mt-2 text-sm input input-bordered form-control bg-base-100" />
                            </label>
                        </form>
                    </div>
                </div>
