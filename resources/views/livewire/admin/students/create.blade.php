            ...
            <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div class="flex flex-wrap mb-6">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="input input-bordered w-full bg-base-300" name="first_name" type="text" placeholder="">
                        @error('first_name')<small class="text-danger">{{$message}}</small> @enderror
                    </div>

                    <div class="w-full md:w-1/2 px-3">
                        <label class="label-text" for="grid-name">Last Name</label>
                        <input class="input input-bordered w-full bg-base-300" name="last_name" type="text" placeholder="">
