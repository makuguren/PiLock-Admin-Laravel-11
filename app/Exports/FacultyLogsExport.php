...
class FacultyLogsExport implements FromQuery, WithHeadings, WithMapping, WithTitle
{
    use Exportable;
    ...
    {
        return [
            $facultyLog->course->faculty->id,
            $facultyLog->course->faculty->first_name . ' ' . $facultyLog->course->faculty->last_name,
