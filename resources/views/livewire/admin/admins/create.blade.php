    ...
    <div class="p-6">
        <div class="flex flex-row">
            <div class="flex flex-col w-full">
                <h1 class="font-bold text-2xl mb-2">Create Admin</h1>
                <ul class="flex items-center text-sm mb-6">
                    ...
                    <li class="text-gray-400 mr-2 font-medium">/</li>
                    <li class="text-gray-600 mr-2 font-medium">Create Admin</li>
                </ul>
            </div>
            ...
            <form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
                ...
                <div class="flex flex-wrap mb-3">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3" name="first_name" type="text" placeholder="">
                        @error('first_name')<small class="text-danger">{{$message}}</small> @enderror
                    </div>

                    <div class="w-full md:w-1/2 px-3">
                        <label class="label-text">Last Name</label>
                        <input class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3" name="last_name" type="text" placeholder="">
                ...
                <div class="flex flex-wrap mb-3">
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3" name="email" type="email" placeholder="">
