<input type="checkbox" id="disable_modal" class="modal-toggle" />
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Disable RFID</h3>
        <form wire:submit.prevent="destroyRFID" method="POST" class="w-full mt-6">
            @csrf
            ...
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_student()" type="button" class="text-white bg-red-700 btn btn-ghost hover:bg-red-500">
