        ...
        <form wire:submit.prevent="updateSchedule" method="dialog" class="w-full mt-6">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <select wire:model="course_id" id="addcourse_id" class="block w-full px-4 py-3 mt-2 mb-4 select select-bordered bg-base-300 form-control" required>
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <select wire:model="days" id="adddays" class="block w-full px-4 py-3 mt-2 mb-4 select select-bordered bg-base-300 form-control" required>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3 md:w-1/3">
                    ...
                    <select wire:model="time_start" id="addtime_start" class="block w-full px-4 py-3 mt-2 mb-4 select select-bordered bg-base-300 form-control" required>
                ...
                <div class="w-full px-3 md:w-1/3">
                    ...
                    <select wire:model="time_end" id="addtime_end" class="block w-full px-4 py-3 mt-2 mb-4 select select-bordered bg-base-300 form-control" required>
