<input type="checkbox" id="block_modal" class="modal-toggle" />
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Block Student</h3>
        <form wire:submit.prevent="destroyEnrollNBlockStud" method="dialog" class="w-full mt-6">
