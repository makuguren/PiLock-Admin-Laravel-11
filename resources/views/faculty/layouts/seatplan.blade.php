        ...
        <div class="drawer-content bg-base-200">
            ...
            <nav class="sticky top-0 z-30 navbar bg-base-100">
                <div data-sveltekit-preload-data class="sticky top-0 z-20 items-center hidden gap-2 px-4 py-2 bg-base-100 bg-opacity-90 backdrop-blur lg:flex ">
                    <!-- Drawer Logo -->
                    <a href="{{ route('faculty.dashboard.index') }}" aria-current="page" aria-label="Homepage" class="px-2 flex-0 btn btn-ghost"
                ...
                <div class="flex-none gap-1">
                    ...
                    <div class="dropdown dropdown-end">
                        <div tabindex="0" role="button" class="btn btn-ghost">
                            ...
                            <span class="hidden font-normal md:inline">Welcome! {{ Auth::user()->first_name }}</span>
                        ...
                        <ul tabindex="0" class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                            <li><a href="{{ route('faculty.logout') }}"
                                ...
                                <form id="logout-form" action="{{ route('faculty.logout') }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </li>
                        </ul>
