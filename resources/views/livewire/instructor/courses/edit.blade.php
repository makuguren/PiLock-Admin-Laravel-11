        ...
        <form wire:submit.prevent="updateCourse" method="dialog" class="w-full mt-6">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="course_code" id="editcourse_code" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3 form-control" type="text">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="course_title" id="editcourse_title" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3 form-control" type="text">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input wire:model="course_key" id="editcourse_key" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3 form-control" type="text">
