...
<div>
    @include('livewire.archive.instructor.seatplan-preview')
    ...
    <div class="p-6">
        <div class="flex flex-row gap-2">
            ...
            <a wire:navigate.hover href="{{ route('archive.instructor.seatplan.assign') }}" class="btn btn-ghost bg-red-700 hover:bg-red-500 w-55 btn-sm mt-3">
