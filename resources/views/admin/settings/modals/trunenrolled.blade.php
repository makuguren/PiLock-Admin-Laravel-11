<input type="checkbox" id="trunenrolled_modal" class="modal-toggle" />
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Truncate Enrolled Courses</h3>
        <form wire:submit.prevent="truncateEnrolledCourses" method="POST" class="w-full mt-6">
            @csrf
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    <h5>Are you Sure you want to Truncate Enrolled Course?</h5>
                </div>
            </div>
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_truncate()" type="button" class="btn btn-ghost bg-red-700 hover:bg-red-500 text-white">
