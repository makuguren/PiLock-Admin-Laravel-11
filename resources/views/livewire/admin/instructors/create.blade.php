        ...
        <form wire:submit.prevent="saveInstructor" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-2">
                <div class="w-full md:w-1/2 px-3 mb-2">
                    ...
                    <input wire:model="first_name" id="addinst_first" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-1 mt-1 form-control" type="text">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input wire:model="last_name" id="addinst_last" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-1 mt-1 form-control" type="text">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <select wire:model="gender" id="addgender" class="select select-bordered bg-base-300 block w-full py-3 px-4 mb-1 mt-1 form-control">
            ...
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="email" id="addinst_email" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-1 mt-1 form-control" type="email">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input wire:model="password" id="addinst_password" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-1 mt-1 form-control" type="password">
