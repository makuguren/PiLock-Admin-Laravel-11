<input type="checkbox" id="trunseatplan_modal" class="modal-toggle" />
<div dialog wire:ignore.self class="modal modal-bottom sm:modal-middle" role="dialog">
    <div class="modal-box">
      <h3 class="text-lg font-bold">Truncate Seat Plan</h3>
        <form wire:submit.prevent="truncateSeatPlan" method="POST" class="w-full mt-6">
            @csrf
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    <h5>Are you Sure you want to Truncate Seat Plan?</h5>
                </div>
            </div>
