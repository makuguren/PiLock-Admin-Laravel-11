            ...
            return response()->json([
                'schedules' => $schedules->map(function ($schedule) {
                    return [
                        ...
                        'faculty' => $schedule->course->faculty->first_name . ' ' . $schedule->course->faculty->last_name,
                ...
                return response()->json([
                    'makeupsched' => $currentmakeup->map(function ($curmakeupsched) {
                        return [
                            ...
                            'faculty' => $curmakeupsched->course->faculty->first_name . ' ' . $curmakeupsched->course->faculty->last_name,
                ...
                return response()->json([
                    'schedule' => $currentsched->map(function ($curschedule) {
                        return [
                            ...
                            'faculty' => $curschedule->course->faculty->first_name . ' ' . $curschedule->course->faculty->last_name,
