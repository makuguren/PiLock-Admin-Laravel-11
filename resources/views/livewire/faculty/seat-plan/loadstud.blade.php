        ...
        <form wire:submit.prevent="loadStudentsData" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    <label class="label-text">Course & Section</label> <span class="text-red-500">*</span>
                    <select wire:model="course_id" id="selsection_id" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" required>
                    ...
                    @error('course_id') <span class="space-y-1 text-sm text-red-600 error" role="alert">{{ $message }}</span> @enderror
                </div>
            </div>
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_load()" type="button" class="text-white bg-red-700 btn btn-ghost hover:bg-red-500">
