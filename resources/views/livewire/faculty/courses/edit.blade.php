        ...
        <form wire:submit.prevent="updateCourse" method="dialog" class="w-full mt-6">
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    <label class="label-text">Code</label> <span class="text-red-500">*</span>
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    <label class="label-text">Title</label> <span class="text-red-500">*</span>
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    <label class="label-text">Section</label> <span class="text-red-500">*</span>
                    <select wire:model="section_id" id="editsection_id" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    <label class="label-text">Enrollment Key</label> <span class="text-red-500">*</span>
