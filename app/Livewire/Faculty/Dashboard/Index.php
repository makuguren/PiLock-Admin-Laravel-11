...
namespace App\Livewire\Faculty\Dashboard;
...
class Index extends Component
{
    ...
    public function render(){
        ...
        // Greetings from Faculties (Mr. and Mrs.) based on Gender.
        ...
        // Fetch Current Schedules based on Faculties Logged In.
        ...
        // Check if the Faculties Using their Default Password
        $checked = 'checked';
        ...
        return view('livewire.faculty.dashboard.index', $data);
    }
}
