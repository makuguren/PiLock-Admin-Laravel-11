        ...
        <div class="w-full mt-6">
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    ...
                    <input wire:model="student_name" id="viewstudent_name" class="block w-full px-4 py-3 mb-2 input input-bordered bg-base-300 mt-2form-control" type="text" readonly>
                </div>
            </div>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <input wire:model="seat_number" id="viewseat_number" class="block w-full px-4 py-3 mt-2 mb-2 input input-bordered bg-base-300 form-control" type="text" readonly>
                </div>
            </div>

            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    <button onclick="cancel_previewseat()" type="button" class="text-white bg-red-700 btn btn-ghost hover:bg-red-500">
