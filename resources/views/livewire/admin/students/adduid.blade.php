<div>
    <div class="p-6">
        <div class="flex flex-row">
            ...
            <a href="{{ route('admin.students.index') }}" class="btn bg-red-700 hover:bg-red-500 w-55 btn-sm mt-3">
        ...
        <div class="bg-base-100 border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
            ...
            <form wire:submit.prevent="updateUIDTag" class="w-full">
                ...
                <div class="flex flex-row mb-6 place-items-center">
                    ...
                    <button wire:click="findStudent" type="button" class="btn bg-blue-700 hover:bg-blue-500 mt-2 w-32">
