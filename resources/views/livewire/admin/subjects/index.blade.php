                        ...
                        <tr>
                            ...
                            <th>
                                <div class="flex flex-row space-x-2">
                                    {{-- @can('Update Subjects') --}}
                                    <label for="edit_modal" wire:click="editSubject({{ $subject->id }})" class="btn bg-blue-700 hover:bg-blue-500 btn-sm h-8">
                                    ...
                                    {{-- @can('Delete Subjects') --}}
                                    <label for="delete_modal" wire:click="deleteSubject({{ $subject->id }})" class="btn bg-red-700 hover:bg-red-500 btn-sm h-8">
