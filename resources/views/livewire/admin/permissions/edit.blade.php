        ...
        <form wire:submit.prevent="updatePermission" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-2">
                <div class="w-full px-3">
                    ...
                    <input wire:model="name" id="editperm_name" class="block w-full px-4 py-3 mt-2 mb-2 input input-bordered bg-base-300 form-control" type="text">
            ...
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_permission()" type="button" class="text-white bg-red-700 btn hover:bg-red-500">
