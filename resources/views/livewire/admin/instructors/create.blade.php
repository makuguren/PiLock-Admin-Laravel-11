        ...
        <form wire:submit.prevent="saveInstructor" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-2">
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input wire:model="first_name" id="addinst_first" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3 form-control" type="text">
                    @error('first_name') <span class="error" role="alert">{{ $message }}</span> @enderror
                </div>

                <div class="w-full md:w-1/2 px-3">
                    <label class="label-text">Last Name</label>
                    <input wire:model="last_name" id="addinst_last" class="input input-bordered bg-base-300 block w-full py-3 px-4 mb-3 form-control" type="text">
