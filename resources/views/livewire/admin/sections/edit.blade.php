        ...
        <form wire:submit.prevent="updateSection" method="dialog" class="w-full mt-6">
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    ...
                    <select wire:model="program" id="addprogram" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" required>
            ...
            <div class="flex flex-wrap mb-4">
                <div class="w-full px-3">
                    ...
                    <select wire:model="year" id="addyear" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" required>
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full px-3">
                    ...
                    <select wire:model="block" id="addblock" class="block w-full px-4 py-3 mt-2 mb-2 select select-bordered bg-base-300 form-control" required>
            ...
            <div class="modal-action">
                <div class="flex flex-row-reverse space-x-2 space-x-reverse">
                    ...
                    <button onclick="cancel_section()" type="button" class="text-white bg-red-700 btn btn-ghost hover:bg-red-500">
