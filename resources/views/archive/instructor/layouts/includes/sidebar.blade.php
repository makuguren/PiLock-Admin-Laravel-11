<div class="drawer-side z-40" style="scroll-behavior: smooth; scroll-padding-top: 5rem;">
    ...
    <aside class="bg-base-100 w-64 h-full">
        ...
        <div data-sveltekit-preload-data class="bg-base-100 sticky top-0 z-20 hidden items-center gap-2 bg-opacity-90 px-4 py-2 backdrop-blur lg:flex ">
            <!-- Drawer Logo -->
            <a wire:navigate.hover href="{{ route('archive.instructor.dashboard.index') }}" aria-current="page" aria-label="Homepage" class="flex-0 btn btn-ghost px-2"
        ...
        <ul class="menu px-4 py-0">
            <li class="mb-1 group {{ Request::is('archive/instructor/dashboard') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('archive.instructor.dashboard.index') }}"
            ...
            <li>
                <details id="disclosure-attendances">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('archive/instructor/attendances') || Request::is('admin/attendances/*') || Request::is('archive/instructor/attendances/current') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('archive.instructor.attendances.index') }}"
            ...
            <li class="mb-1 group {{ Request::is('archive/instructor/events') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('archive.instructor.events.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li>
                <details id="disclosure-courses">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('archive/instructor/courses') || Request::is('archive/instructor/courses/blockedstudents') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('archive.instructor.courses.index') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Your Courses
                            </a>
                        </li>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('archive.instructor.courses.blocked') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Blocked Students
                            </a>
                        </li>
            ...
            <li class="mb-1 group {{ Request::is('archive/instructor/students') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('archive.instructor.students.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li>
                <details id="disclosure-schedules">
                    <summary class="hover:bg-blue-400 hover:text-white {{ Request::is('archive/instructor/schedules') || Request::is('archive/instructor/schedules/makeupscheds') ? 'group bg-blue-700 text-white':'' }}">
                        <span>
                    ...
                    <ul>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('archive.instructor.schedules.index') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
                                Your Schedules
                            </a>
                        </li>
                        <li class="">
                            <a wire:navigate.hover href="{{ route('archive.instructor.schedules.makeup') }}"
                                class="group text-sm flex items-center hover:text-blue-700 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">
            ...
            <li class="mb-1 group {{ Request::is('archive/instructor/seatplan') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('archive.instructor.seatplan.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
            ...
            <li class="mb-1 group {{ Request::is('archive/instructor/settings') ? 'active':'' }}">
                <a wire:navigate.hover href="{{ route('archive.instructor.settings.index') }}"
                    class="flex items-center py-2 px-4 hover:bg-blue-400 hover:text-white rounded-md group-[.active]:bg-blue-700 group-[.active]:text-white group-[.selected]:bg-blue-700 group-[.selected]:text-gray-200">
